...
```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
funtion_time_delay("Faelle")
```



```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
funtion_dis_delay("Faelle")
```

```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
funtion_time_delay("Totesfaelle")
```

```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
funtion_dis_delay("Totesfaelle")
```
...
```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
function_plot_meldungen("Faelle")
```

```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
function_plot_meldungen("Totesfaelle")
```
...
```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
function_reproductive_table("short") %>%
  kbl(caption = "Serial interval  = 2.6 days") %>%
  kable_classic(full_width = F, html_font = "Cambria")
```

<!-- ## Time serial interval 4.0 days  -->
```{r, echo=FALSE, warning=FALSE, fig.height =8 , fig.width = 15,message=FALSE}
function_reproductive_table("long")%>%
  kbl(caption = "Serial interval = 4  days") %>%
  kable_classic(full_width = F, html_font = "Cambria")
```
