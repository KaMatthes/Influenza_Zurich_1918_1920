...
# write.xlsx(Results_R0_long,"output/Results_R0_long.xlsx", rowNames=FALSE, overwrite = TRUE)
...
else if(interval_length == "medium") {
  
  
  
  RO.inc.canton1 <- function_reproductive(1,"CantonCases", 1918, 25, 31, 3,1)
  RO.inc.city1 <- function_reproductive(1,  "CityCases" , 1918, 25, 31, 3,1)
  RO.death.city1 <- function_reproductive(1,  "CityDeathsTotal" , 1918, 25, 31, 3,1)
  ...
  RO.inc.city3 <- function_reproductive(3,  "CityCases" , 1920, 2,9, 3,1)
  RO.death.city3 <- function_reproductive(3,  "CityDeathsTotal" , 1920, 2, 9, 3,1)
  RO.hos.city3 <- function_reproductive(3,  "Andere_Infekt" , 1920, 2,9, 3,1)
  
  
  RO.inc.city4 <- function_reproductive(4,"Faelle", 1918, 36, 43, 3,1)
  RO.inc.city5 <- function_reproductive(5,"Faelle", 1918, 36, 43, 3,1)
  
  
  RO.inc.Meldungen4 <- function_reproductive(4,"Faelle", 1918, 36, 43, 3,1)
  RO.inc.Meldungen5 <- function_reproductive(5,"Faelle", 1918, 36, 43, 3,1)
  
  RO.death.Meldungen4 <- function_reproductive(4,"Totesfaelle", 1918, 36, 43, 3,1)
