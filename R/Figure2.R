...
Figure_Re_inc <- ggplot() +
  ...
  ggtitle("A) Reproduction numbers of reported flu cases") +
  theme_bw()+
  #theme_light(base_size = 16)+
  theme(axis.text.y = element_text(size=text_size),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        legend.position = c(.53, .88),
...
#   xlab("Month/Year")+
#   ylab("Reproduction number")+
#   ggtitle("B) Reproduction number of total number of death") +
#   theme_bw()+
#   #theme_light(base_size = 16)+
#   theme(axis.text.y = element_text(size=text_size),
#         panel.grid.major.x = element_blank(),
...
Figure_Re_hos <- ggplot() +
  ...
  xlab("Month/Year")+
  ylab("Reproduction number")+
  ggtitle("B) Reproduction number of hospitalisations -  infection incl.Influenza") +
  theme_bw()+
  theme(axis.text.y = element_text(size=text_size),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
...
Figure2 <- cowplot::plot_grid(Figure_Re_inc,NULL,Figure_Re_hos,
                                    ncol=1, nrow=3, align="hv",
                                    rel_heights = c(1,-0.1,1))


cowplot::save_plot(paste0("output/Figure2.pdf"), Figure2 ,base_height=12,base_width=15)
